...
if (document.forms["myForm"]["position"].value=="")
  {
  alert("Step 1 Application : Position ?");
...
if (document.forms["myForm"]["title"].value=="")
  {
  alert("Step 1 Application :Please Enter Title(Mr / Mrs / Ms / Other)");
...
if (document.forms["myForm"]["postcode"].value=="")
 ...
 if( document.getElementById('roll_no').value<=1)
 {
  alert("Step 1 Application :Please state At least one previous addresses where you have lived for the past six years");
  document.forms["myForm"]["postcode"].focus();
  return false;
}
...
if (document.forms["myForm"]["passnumber"].value=="")
  ...
  {
  alert("Step 1 Application : Emergency Contact => Home Address ?");
  document.forms["myForm"]["emergency_home"].focus();
  return false;
  }
    if (document.forms["myForm"]["emergency_office"].value=="")
  {
  alert("Step 1 Application : Emergency Contact => Office no ?");
...
/////////////////////////////////////////////
  ...
  if( document.getElementById('datemedical').value=="")
 {
  alert("Step 2 Medical Form : Date Missing ?");
  return false;
 }
  if( document.getElementById('3_emp_name').value=="")
 {
  alert("Step 3 BANK : Employee Name ?");
  return false;
 }
 
   if( document.getElementById('datefst2').value=="")
  {
  alert("Step 3 BANK : Date ?");
  return false;
  }
